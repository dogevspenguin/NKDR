# NKDR
NKDR official
Send pull requests to dev branch or discord/ksp forum all others will be rejected.
Hey NKD workin?
YESSS Absolutly this is going to be a fun ride
form small davy to montrosity Tsar this mod contain variety of part and some new one :W
also this mod is frequetly develop by me and NSI as i want to bring this mod back again with more customization and it own working plugin
using UnityEngine;
using BDArmory.Misc;
using BDArmory.FX;
